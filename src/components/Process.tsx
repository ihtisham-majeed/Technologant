                ...
                <div className="w-24 h-24 bg-white dark:bg-[#0f0f0f] border-4 border-gray-50 rounded-full flex items-center justify-center mb-6 group-hover:border-indigo-100 transition-colors duration-300">
                  ...
                  >
                    <Icon
                      size={28}
                      className="
                    text-blue-600                 /* default light mode color */
                    dark:text-blue-600            /* dark mode stays blue */
                    group-hover:text-white        /* hover in light mode turns white */
                    dark:group-hover:text-white   /* hover in dark mode turns white */
